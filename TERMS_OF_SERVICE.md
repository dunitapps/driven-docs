...
The App is licensed, not sold. These Terms supplement the [Apple Standard Licensed Application End User License Agreement](https://www.apple.com/legal/internet-services/itunes/dev/stdeula/) (**“Apple Standard EULA”**) and applicable Apple Media Services terms. They do not replace mandatory Apple terms or mandatory consumer law. If there is a conflict:
...
The [Driven Privacy Policy](PRIVACY_POLICY.md) explains data handling and forms part of the information supplied with these Terms.
...
- a full or minimal driving dashboard;
- live GPS-derived speed presentation;
- Apple Maps display, place search, nearby search, route planning, rerouting, and navigation guidance;
- OpenStreetMap-derived road speed-limit information and speeding indications;
- OpenStreetMap-derived speed-camera information and alerts;
...
- temporary, conditional, variable, electronic, implicit, national-default, advisory, minimum, night, seasonal, school-zone, construction, vehicle-specific, trailer-specific, weight-specific, lane-specific, or direction-specific limits;
- changes that have not yet reached OpenStreetMap or a public cache;
- a road that is close to another road or has complex levels and geometry; or
- a limit during missing location, route, network, or provider data.
...
- **Calls:** Confirm the displayed person and number before initiating a call. The system Phone app, carrier, calling service, and recipient control the call. Emergency calling and carrier availability are not guaranteed by Driven.
- **Calendar:** Event content can be incomplete, stale, duplicated, incorrectly timed, or affected by a calendar provider or time-zone setting. Do not rely on Driven for a legal, medical, travel, work, or emergency deadline.
- **Apple Music:** Library, catalog, recommendations, artwork, subscription eligibility, playback, and availability are controlled by Apple and rights holders. Content can change or disappear and can incur data charges.
- **Wallpaper:** Use only images you have the right and permission to use. Do not select unlawful, infringing, exploitative, confidential, or privacy-violating content. Wallpaper readability varies; choose a background that does not obscure driving information or distract the driver.
...
- use the App or data to stalk, harass, discriminate, identify a person, expose a sensitive place, violate privacy, or cause harm;
- use data returned by the App as an official record, legal evidence, certified measurement, or safety guarantee; or
- use the App in warfare, weapon systems, critical infrastructure, or another prohibited critical context.
...
- the subject **“Driven Complaint”**;
- a clear description of the issue and requested remedy;
- App and iOS versions, if relevant;
- the transaction date and Apple order reference, if relevant, with payment-card details removed; and
- supporting screenshots that do not unnecessarily reveal location, contacts, calendar events, or other sensitive data.
...
- **Assignment:** You may not assign these Terms except where mandatory law allows. We may assign them as part of a sale, reorganization, or transfer of the App, provided the successor assumes the relevant obligations and users receive notice where required.
- **No partnership:** These Terms do not create employment, agency, partnership, fiduciary duty, or joint venture.
...
- Date of purchase: ............................................................
- Apple order reference (remove any payment-card details): ............................................................
